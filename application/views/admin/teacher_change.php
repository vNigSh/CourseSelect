			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="<?php echo site_url('admin/main/teacher_change'); ?>" method="post">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">工号：</label>
							  <div class="controls">
							  <?php echo $teacher_info[0]['t_id']; ?>
								<input type="hidden" name="t_id" value="<?php echo $teacher_info[0]['t_id']; ?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">姓名：</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="t_username" value="<?php echo $teacher_info[0]['t_username']; ?>">
							  </div>
							</div>
							<div class="control-group">
							  ...
							  <div class="controls">
								  <select id="selectError3" name="t_subject">
									<?php foreach($subject_list as $item){ ?>
										<?php if($item['su_id']==$teacher_info[0]['t_subject']){ ?>
